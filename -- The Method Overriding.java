...
class Circle extends Shape {
    @Override
    void area() { System.out.println("Area of The Circle = π * r^2"); } // Overriding method
}

class Rectangle extends Shape {
    @Override
    void area() { System.out.println("Area of The Rectangle = length * width"); } // Overriding method
}
